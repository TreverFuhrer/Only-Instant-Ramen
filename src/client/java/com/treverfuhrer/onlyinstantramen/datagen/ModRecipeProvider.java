...
public class ModRecipeProvider extends FabricRecipeProvider{
    ...
    public void generate(RecipeExporter exporter) {
        ...
        List<RamenRecipe> ramenRecipes = List.of(
            // Base
            new RamenRecipe(ModItems.NOODLES, List.of(Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET), "noodles"),
            new RamenRecipe(ModItems.RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET), "ramen"),
            new RamenRecipe(ModItems.RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET), "ramen_from_noodles"),

            /* ---------- STRENGTH ---------- */
            // Beef Ramen
            new RamenRecipe(ModItems.BEEF_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.COOKED_BEEF), "beef_ramen"),
            new RamenRecipe(ModItems.BEEF_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.COOKED_BEEF), "beef_ramen_from_noodles"),
            new RamenRecipe(ModItems.BEEF_RAMEN, List.of(ModItems.RAMEN, Items.COOKED_BEEF), "beef_ramen_from_ramen"),
            // Brute Ramen
            new RamenRecipe(ModItems.BRUTE_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.COOKED_BEEF, Items.BLAZE_POWDER), "brute_ramen"),
            new RamenRecipe(ModItems.BRUTE_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.COOKED_BEEF, Items.BLAZE_POWDER), "brute_ramen_from_noodles"),
            ...
            /* ---------- REGENERATION ---------- */
            // Herbal Ramen
            new RamenRecipe(ModItems.HERBAL_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.SUGAR), "herbal_ramen"),
            new RamenRecipe(ModItems.HERBAL_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.SUGAR), "herbal_ramen_from_noodles"),
            new RamenRecipe(ModItems.HERBAL_RAMEN, List.of(ModItems.RAMEN, Items.SUGAR), "herbal_ramen_from_ramen"),
            // Goldenleaf Ramen
            new RamenRecipe(ModItems.GOLDENLEAF_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.SUGAR, Items.GHAST_TEAR), "goldenleaf_ramen"),
            new RamenRecipe(ModItems.GOLDENLEAF_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.SUGAR, Items.GHAST_TEAR), "goldenleaf_ramen_from_noodles"),
            ...
            /* ---------- NIGHT VISION ---------- */
            // Glowberry Ramen
            new RamenRecipe(ModItems.GLOWBERRY_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.GLOW_BERRIES), "glowberry_ramen"),
            new RamenRecipe(ModItems.GLOWBERRY_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.GLOW_BERRIES), "glowberry_ramen_from_noodles"),
            new RamenRecipe(ModItems.GLOWBERRY_RAMEN, List.of(ModItems.RAMEN, Items.GLOW_BERRIES), "glowberry_ramen_from_ramen"),
            // Fox Ramen
            new RamenRecipe(ModItems.FOX_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.GLOW_BERRIES, Items.GOLDEN_CARROT), "fox_ramen"),
            new RamenRecipe(ModItems.FOX_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.GLOW_BERRIES, Items.GOLDEN_CARROT), "fox_ramen_from_noodles"),
            ...
            // Faint Ramen
            new RamenRecipe(ModItems.FAINT_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.GLOW_BERRIES, Items.FERMENTED_SPIDER_EYE), "faint_ramen"),
            new RamenRecipe(ModItems.FAINT_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.GLOW_BERRIES, Items.FERMENTED_SPIDER_EYE), "faint_ramen_from_noodles"),
            ...
            // Ghost Ramen
            new RamenRecipe(ModItems.GHOST_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.GLOW_BERRIES, Items.GOLDEN_CARROT, Items.FERMENTED_SPIDER_EYE), "ghost_ramen"),
            new RamenRecipe(ModItems.GHOST_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.GLOW_BERRIES, Items.GOLDEN_CARROT, Items.FERMENTED_SPIDER_EYE), "ghost_ramen_from_noodles"),
            ...
            /* ---------- JUMP BOOST ---------- */
            // Rabbit Ramen
            new RamenRecipe(ModItems.RABBIT_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.RABBIT_HIDE), "rabbit_ramen"),
            new RamenRecipe(ModItems.RABBIT_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.RABBIT_HIDE), "rabbit_ramen_from_noodles"),
            new RamenRecipe(ModItems.RABBIT_RAMEN, List.of(ModItems.RAMEN, Items.RABBIT_HIDE), "rabbit_ramen_from_ramen"),
            // Leaping Ramen
            new RamenRecipe(ModItems.LEAPING_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.RABBIT_HIDE, Items.RABBIT_FOOT), "leaping_ramen"),
            new RamenRecipe(ModItems.LEAPING_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.RABBIT_HIDE, Items.RABBIT_FOOT), "leaping_ramen_from_noodles"),
            ...
            /* ---------- SLOW FALLING ---------- */
            // Feather Ramen
            new RamenRecipe(ModItems.FEATHER_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.FEATHER), "feather_ramen"),
            new RamenRecipe(ModItems.FEATHER_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.FEATHER), "feather_ramen_from_noodles"),
            new RamenRecipe(ModItems.FEATHER_RAMEN, List.of(ModItems.RAMEN, Items.FEATHER), "feather_ramen_from_ramen"),

            // Cloud Ramen
            new RamenRecipe(ModItems.CLOUD_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.FEATHER, Items.PHANTOM_MEMBRANE), "cloud_ramen"),
            new RamenRecipe(ModItems.CLOUD_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.FEATHER, Items.PHANTOM_MEMBRANE), "cloud_ramen_from_noodles"),
            ...
            /* ---------- FIRE RESISTANCE ---------- */
            // Spicy Ramen
            new RamenRecipe(ModItems.SPICY_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.REDSTONE), "spicy_ramen"),
            new RamenRecipe(ModItems.SPICY_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.REDSTONE), "spicy_ramen_from_noodles"),
            new RamenRecipe(ModItems.SPICY_RAMEN, List.of(ModItems.RAMEN, Items.REDSTONE), "spicy_ramen_from_ramen"),

            // Blazing Ramen
            new RamenRecipe(ModItems.BLAZING_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.REDSTONE, Items.MAGMA_CREAM), "blazing_ramen"),
            new RamenRecipe(ModItems.BLAZING_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.REDSTONE, Items.MAGMA_CREAM), "blazing_ramen_from_noodles"),
            ...
            /* ---------- WATER BREATHING ---------- */
            // Turtle Ramen
            new RamenRecipe(ModItems.TURTLE_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.TURTLE_SCUTE), "turtle_ramen"),
            new RamenRecipe(ModItems.TURTLE_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.TURTLE_SCUTE), "turtle_ramen_from_noodles"),
            new RamenRecipe(ModItems.TURTLE_RAMEN, List.of(ModItems.RAMEN, Items.TURTLE_SCUTE), "turtle_ramen_from_ramen"),

            // Deepsea Ramen
            new RamenRecipe(ModItems.DEEPSEA_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.TURTLE_SCUTE, Items.PUFFERFISH), "deepsea_ramen"),
            new RamenRecipe(ModItems.DEEPSEA_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.TURTLE_SCUTE, Items.PUFFERFISH), "deepsea_ramen_from_noodles"),
            ...
            /* ---------- SWIFTNESS ---------- */
            // Carrot Ramen
            new RamenRecipe(ModItems.CARROT_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.CARROT), "carrot_ramen"),
            new RamenRecipe(ModItems.CARROT_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.CARROT), "carrot_ramen_from_noodles"),
            new RamenRecipe(ModItems.CARROT_RAMEN, List.of(ModItems.RAMEN, Items.CARROT), "carrot_ramen_from_ramen"),

            // Swift Ramen
            new RamenRecipe(ModItems.SWIFT_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.CARROT, Items.SUGAR), "swift_ramen"),
            new RamenRecipe(ModItems.SWIFT_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.CARROT, Items.SUGAR), "swift_ramen_from_noodles"),
            ...
            /* ---------- HEALING ---------- */
            // Mend Ramen
            new RamenRecipe(ModItems.MEND_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.MELON_SLICE), "mend_ramen"),
            new RamenRecipe(ModItems.MEND_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.MELON_SLICE), "mend_ramen_from_noodles"),
            new RamenRecipe(ModItems.MEND_RAMEN, List.of(ModItems.RAMEN, Items.MELON_SLICE), "mend_ramen_from_ramen"),

            // Revive Ramen
            new RamenRecipe(ModItems.REVIVE_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.MELON_SLICE, Items.GLISTERING_MELON_SLICE), "revive_ramen"),
            new RamenRecipe(ModItems.REVIVE_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.MELON_SLICE, Items.GLISTERING_MELON_SLICE), "revive_ramen_from_noodles"),
            ...
            new RamenRecipe(ModItems.STONE_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.COBBLESTONE), "stone_ramen"),
            new RamenRecipe(ModItems.STONE_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.COBBLESTONE), "stone_ramen_from_noodles"),
            ...
            new RamenRecipe(ModItems.IRON_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.COBBLESTONE, Items.IRON_INGOT), "iron_ramen"),
            new RamenRecipe(ModItems.IRON_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.COBBLESTONE, Items.IRON_INGOT), "iron_ramen_from_noodles"),

            /* ---------- POISON ---------- */
            // Rotten Ramen
            new RamenRecipe(ModItems.ROTTEN_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.SPIDER_EYE), "rotten_ramen"),
            new RamenRecipe(ModItems.ROTTEN_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.SPIDER_EYE),"rotten_ramen_from_noodles"),
            new RamenRecipe(ModItems.ROTTEN_RAMEN, List.of(ModItems.RAMEN, Items.SPIDER_EYE), "rotten_ramen_from_ramen"),

            // Virulent Ramen
            new RamenRecipe(ModItems.VIRULENT_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.SPIDER_EYE, Items.GLOWSTONE_DUST), "virulent_ramen"),
            new RamenRecipe(ModItems.VIRULENT_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.SPIDER_EYE, Items.GLOWSTONE_DUST), "virulent_ramen_from_noodles"),
            ...
            // Vicious Ramen
            new RamenRecipe(ModItems.VICIOUS_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.MELON_SLICE, Items.FERMENTED_SPIDER_EYE), "vicious_mend_ramen"),
            new RamenRecipe(ModItems.VICIOUS_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.MELON_SLICE, Items.FERMENTED_SPIDER_EYE), "vicious_mend_ramen_from_noodles"),
            ...
            new RamenRecipe(ModItems.VICIOUS_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.SPIDER_EYE, Items.FERMENTED_SPIDER_EYE), "vicious_rotten_ramen"),
            new RamenRecipe(ModItems.VICIOUS_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.SPIDER_EYE, Items.FERMENTED_SPIDER_EYE), "vicious_rotten_ramen_from_noodles"),
            ...
            new RamenRecipe(ModItems.VICIOUS_RAMEN, List.of(ModItems.ROTTEN_RAMEN, Items.FERMENTED_SPIDER_EYE), "vicious_rotten_ramen_from_rotten_ramen"),
            
            // Blighted Ramen
            new RamenRecipe(ModItems.BLIGHTED_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.MELON_SLICE, Items.GLISTERING_MELON_SLICE, Items.FERMENTED_SPIDER_EYE), "blighted_revive_ramen"),
            new RamenRecipe(ModItems.BLIGHTED_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.MELON_SLICE, Items.GLISTERING_MELON_SLICE, Items.FERMENTED_SPIDER_EYE), "blighted_revive_ramen_from_noodles"),
            ...
            new RamenRecipe(ModItems.BLIGHTED_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.SPIDER_EYE, Items.GLOWSTONE_DUST, Items.FERMENTED_SPIDER_EYE), "blighted_ramen_virulent"),
            new RamenRecipe(ModItems.BLIGHTED_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.SPIDER_EYE, Items.GLOWSTONE_DUST, Items.FERMENTED_SPIDER_EYE), "blighted_ramen_virulent_from_noodles"),
            ...
            // Thick Ramen
            new RamenRecipe(ModItems.THICK_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.RABBIT_HIDE, Items.FERMENTED_SPIDER_EYE), "thick_rabbit_ramen"),
            new RamenRecipe(ModItems.THICK_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.RABBIT_HIDE, Items.FERMENTED_SPIDER_EYE), "thick_rabbit_ramen_from_noodles"),
            ...
            new RamenRecipe(ModItems.THICK_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.CARROT, Items.FERMENTED_SPIDER_EYE), "thick_carrot_ramen"),
            new RamenRecipe(ModItems.THICK_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.CARROT, Items.FERMENTED_SPIDER_EYE), "thick_carrot_ramen_from_noodles"),
            ...
            // Gelatinous Ramen
            new RamenRecipe(ModItems.GELATINOUS_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.RABBIT_HIDE, Items.RABBIT_FOOT, Items.FERMENTED_SPIDER_EYE), "gelatinous_leaping_ramen"),
            new RamenRecipe(ModItems.GELATINOUS_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.RABBIT_HIDE, Items.RABBIT_FOOT, Items.FERMENTED_SPIDER_EYE), "gelatinous_leaping_ramen_from_noodles"),
            ...
            new RamenRecipe(ModItems.GELATINOUS_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.CARROT, Items.SUGAR, Items.FERMENTED_SPIDER_EYE), "gelatinous_swift_ramen"),
            new RamenRecipe(ModItems.GELATINOUS_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.CARROT, Items.SUGAR, Items.FERMENTED_SPIDER_EYE), "gelatinous_swift_ramen_from_noodles"),
            ...
            // Spoiled Ramen
            new RamenRecipe(ModItems.SPOILED_RAMEN, List.of(Items.BOWL, Items.WHEAT, Items.WHEAT, Items.EGG, Items.WATER_BUCKET, Items.COOKED_BEEF, Items.FERMENTED_SPIDER_EYE), "spoiled_ramen"),
            new RamenRecipe(ModItems.SPOILED_RAMEN, List.of(Items.BOWL, ModItems.NOODLES, Items.WATER_BUCKET, Items.COOKED_BEEF, Items.FERMENTED_SPIDER_EYE), "spoiled_ramen_from_noodles"),
